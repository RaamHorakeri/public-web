            ...
            <section className="w-full h-auto bg-white p-[120px_87px] gap-[60px]">
                ...
                <div className="flex bg-white  rounded-md w-full h-auto p-[30px]">
                    ...
                    <div className="flex-1 flex flex-col gap-[40px]">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center mt-[20px]">
                                <button className="bg-white text-[#7C56CF] py-2 px-6 rounded border border-2 border-[#7C56CF] w-[120px] h-[48px] rounded-[5px]">
                                    Get Help
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="w-[396px] h-auto flex flex-col gap-[26px] ml-[30px]">
                        <div className="flex flex-col gap-[26px] bg-white p-[15px] rounded-md rounded-lg border border-2 border-[#7C56CF]  ">
                            {/* h4 Tag */}
                            <h4 className="bg-[#F2EEFA] p-[10px] text-center font-roboto font-semibold text-[20px] leading-[43px]">
                                Java Software Engineer
                            </h4>

                            {/* p Tag with Icon and Text */}
