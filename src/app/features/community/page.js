        ...
        <div>
            ...
            <div className="container mx-auto  mt-16 flex justify-between">
                ...
                <div className="w-[399.02px] h-[285.9px] gap-[48px] ">
                    ...
                    <div className="relative mb-4 w-[342px] h-[49px] mb-12">
                        <input
                            type="text"
                            placeholder="Search in Community"
                            className="w-full px-4 py-2 border rounded w-[342px] h-[45px]"
                        />
                ...
                <div className="w-[752px]">
                    ...
                    <div className="flex justify-between items-center mb-6 w-[790px] h-[50px] ">
                        <p className="text-[14px] text-[#000000] font-normal font-roboto leading-[14.4px] w-[168px]  h-[14px] ">Updated on March 1, 2024</p>
                    ...
                    <div className="h-[1943px]">
                        ...
                        <div className="h-[268px] w-[788px]  mb-4">
                            <p className="text-xs font-bold font-roboto leading-[19.2px] mb-2 text-primary-1600">Asked By : <span className='font-normal'>Mathew Doe</span> </p>
                            <p className=" font-roboto font-medium text-s leading-s text-base mb-4 w-[755px] h-[90px] ">
                                ...
                                platform. How I can do it? I spent 3 days googling here and there
                                but didn’t manage to find a guide. Please help me.
                            </p>

                            {/* Tags */}
                            <div className="flex items-center space-x-2 mb-4  w-[787px] h-[55px] ">
                                <span className="bg-[#F3F3F3] rounded-sm text-center flex justify-center items-center font-roboto text-[14px] leading-[16.8px] w-[90px] h-[31px] ">Engineering</span>
                                <span className="bg-[#F3F3F3] rounded-sm text-center flex justify-center items-center font-roboto text-[14px] leading-[16.8px] w-[90px] h-[31px]">Security</span>
                            </div>
                            ...
                            <div className="flex space-x-4 w-[787px] h-[50px] ">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        className={`h-5 w-5 mt-1 transform ${showAnswers ? "rotate-180" : ""
                                            }`}
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                                    >
                                ...
                                <button onClick={() => handleMenuItemClick("Add a Comment")} className={`text-[#0A0A0B] font-roboto font-normal text-xs leading-[19.2px] ${activeItem === "Add a Comment" ? 'text-primary' : 'text-[#0A0A0B]'} `}>Add a Comment</button>
                                <button onClick={() => handleMenuItemClick("Add an Answer")} className={`text-[#0A0A0B] font-roboto font-normal text-xs leading-[19.2px] ${activeItem === "Add an Answer" ? 'text-primary' : 'text-[#0A0A0B]'} `}>Add an Answer</button>
                                <button onClick={() => handleMenuItemClick("View Accepted Answers")} className={`text-[#0A0A0B] font-roboto font-normal text-xs leading-[19.2px] ${activeItem === "View Accepted Answers" ? 'text-primary' : 'text-[#0A0A0B]'} `}>View Accepted Answers</button>
                            </div>
                        </div>
                            ...
                            <div className="w-[788px] h-[1635px] p-4 border border-[#D9D9D9] mt-4">
                                ...
                                <div className="w-[748px] h-auto mt-8 ">
                                    ...
                                    <div className="flex items-center  px-[16px] py-[12px] gap-[6px] mb-4 w-[748px] h-[43px]">
                                        <h6 className="text-xs font-normal leading-[19.2px] font-roboto font-bold text-primary-1600 h-[19px] ">Wicky Kaye</h6>
                                    ...
                                    <div className="w-[748px] h-[200px] py-[10px] px-[16px] mb-4 ">
                                        <p className="text-xs leading-s font-roboto font-normal w-[716px] h-[180px]">
                                            Hi, <span className='text-primary' >@Mathew Doe</span><br />
                                             Sometimes IP addresses will be listed
                                            without SPAM originating from the IP, but either from the
                                            same IP range or from the provider itself.<br /> This mechanics is
                                            usually done from RBLs by default and can be really
                                            annoying. The best step here will be to request a delist,
                                            this can take from a few seconds to a few hours.<br /> Hope that
                                            this helps!
                                        </p>
                                    </div>
                                    ...
                                    <div className="w-[748px] h-[50px] px-[8px] flex justify-between items-center ">
                                        ...
                                        <div className="flex justify-between w-[294px] h-[50px] ">
                                            ...
                                            >
                                                Show Comments   <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className={`h-5 w-5 mt-0 transform ${showComments ? "rotate-180" : ""
                                            }`}
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                                    >
                                        ...
                                        <div className="flex space-x-4">
                                            <button className="text-xs font-roboto font-bold text-[#0A0A0B] leading-[19.2px] ">Upvote</button>
                                            <button className="ext-xs font-roboto font-bold text-[#0A0A0B] leading-[19.2px] ">Downvote</button>
                                        </div>
                                    </div>
                                    ...
                                    {showCommentForm && (
                                        <div className="w-[748px] h-[143px] mt-4  gap-[10px] ">
                                            <h6 className="text-s font-roboto font-medium leading-[24px] bg-secondary-100 h-[48px] flex items-center px-[16px] py-[12px] border border-[#D9D9D9] border-b-0 ">Add a Comment</h6>
                                            <textarea
