    ...
    <>
      ...
      <section className="flex flex-col items-center gap-ml py-ml px-[87px] ">
        {cardDetails.map((card, index) => (
          ...
          >
            <div
              className="flex flex-col  pl-2 gap-[30px] justify-center mt-[60px] space-y-3 "
              style={{ width: "840px", height: "204px" }}
            >
              <h3
                className="font-roboto font-bold text-primary-1600 text-xs leading-[19.2px]"
                style={{ width: "336px", height: "19px" }}
              >
                {card.cardHead}
              </h3>
              <p
                className="font-roboto font-normal text-xs text-secondary-1000 leading-s"
