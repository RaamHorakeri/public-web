  ...
  return (
    <>
      <section className="bg-primary-100 py-0 px-[87px] h-[500px] flex flex-col items-center justify-center gap-m">
        <h1 className="font-roboto text-primary-1600 font-semibold text-l leading-l text-center">
        ...
        <div className="flex gap-6">
          <a href="#" className="bg-primary-100 text-primary font-medium py-2 px-6 rounded-m border border-2 border-primary">
            Get Started
          </a>
          <a href="#" className="bg-primary font-medium text-secondary-100 border-2  py-2 px-6 rounded-m">
            Enroll Now
          </a>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center gap-ml py-ml px-[87px]">

        {
          cardDetails.map((card ,index)=> (
            <div key={index} className="flex bg-white p-6 rounded-lg border border-2 border-primary w-[1266px] h-[264px] gap-ml">
          ...
          <div className="flex flex-col gap-4" style={{ width: '336px', height: '204px' }}>
            <a href="#" className="bg-white text-center text-primary font-medium py-2 px-m rounded-m border border-2 border-primary" style={{ width: '336px', height: '48px' }}>
             {card.cardButtons[0]}
            </a>
      ...
      <div className="flex justify-center">
        <a href="#" className="bg-primary text-secondary-100 py-3 px-4 rounded-m font-medium text-center mt-10 mb-20" style={{ width:"179px", height:"48px"}}>
          View More
        </a>
      </div>
    </>
