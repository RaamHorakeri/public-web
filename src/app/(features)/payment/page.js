    ...
    <div className="flex justify-around p-20">
      <div className=" w-[525px] ">
        <div className="flex items-center mb-4">
          <h2 className="text-[#061856] font-roboto text-[17.3px] font-semibold">
            Payment Method
          </h2>
      ...
      <div className="w-[540px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex space-x-4">
            <div className="w-1/2">
              <label className="block font-roboto text-[9px] mb-2 font-normal">
                Name on Card
              </label>
              <Input
                type="text"
          ...
          <button
            type="button"
            className="mt-4  flex justify-center items-center bg-primary text-secondary-100 w-[100px] h-[31px] "
          >
            Save
          </button>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center mb-4">
              <Input
                ...
                height="h-[18px]"
              />
              <label className="font-roboto font-normal text-xs leading-[32.35px] ">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-primary font-roboto font-bold text-xs leading-[35px] text-secondary-100 w-[523px] h-[47px] "
            >
              Confirm
            </button>
          </div>
