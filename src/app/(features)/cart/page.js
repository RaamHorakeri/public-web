  ...
  return (
    <div>
      <section className="bg-secondary-100 w-full h-[150px] flex justify-center items-center ">
        <h1 className=" font-roboto font-bold text-[24px] leading-[50px] ">
          Selected Option
        </h1>
      </section>
      <section className="  h-[436px] flex justify-evenly items-center ">
        <div className=" -mt-6 ">
          <h3 className="font-roboto font-bold text-[24px] leading-[50px] ">
            Selected Duration
          </h3>
          <p className="font-roboto font-normal text-s leading-[50px] ">
            Selected Duration
          </p>
        </div>
            ...
            <tbody>
              {cartData.map((cart, index) => {
                return (
                  <tr
                    key={index}
                    className=" p-4 flex justify-between items-center h-[46px]  w-[824px]"
                  >
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-primary text-secondary-100 flex justify-center items-center rounded-m font-roboto text-s leading-6 font-medium text-center mb-32"
          style={{ width: "111px", height: "48px" }}
        >
          Pay Now
        </button>
      </div>
